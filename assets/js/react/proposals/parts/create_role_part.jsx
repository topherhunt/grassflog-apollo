...
class CreateRolePart extends React.Component {
  ...
  render() {
    ...
    return <div>
      ...
      <MoveRolesSection
        ...
        partRole={this.stubNewRoleDetails()}
        getFormField={this.getFormField.bind(this)}
        updateForm={this.updateForm.bind(this)}
        queueSaveProposalPart={this.queueSaveProposalPart}
      />
  ...
  // This is a new role, so we don't know the id yet and there are no children.
  stubNewRoleDetails() {
    return {id: "__PART_TARGET_ID__", children: [], isCircle: false}
  }
