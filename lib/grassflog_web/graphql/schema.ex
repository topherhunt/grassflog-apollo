...
defmodule GrassflogWeb.Graphql.Schema do
  ...
  mutation do
    ...
    field :update_proposal_part, type: :proposal_part do
      arg :id, non_null(:id)
      # This is parsed as json, but I'll use String type for simplicity
      arg :changes_json, :string
      resolve &Resolvers.update_proposal_part/3
    end
